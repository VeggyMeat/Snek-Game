...
{
    public static ProjectileController Shoot(GameObject projectile, Vector3 position, float angle, string jsonPath, Class controller)
    {
        ...
        projController.Setup(jsonPath, controller);
